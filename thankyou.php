                            ...
                            <div class="row as-search-navbar" id="as-search-navbar" style="width: auto;">
                                <div class="as-accessories-filter-tile column large-6 small-3">
                                    ...
                                    <button class="as-filter-button" aria-expanded="true" aria-controls="as-search-filters" type="button">
                                        ...
                                        ?>
                                        <h2 class=" as-filter-button-text">
                                            No pudimos recibir tu pago
                                        </h2>
                                        <?php
                                        } elseif($_GET['result'] == 'pending') {
                                        ?>
                                        <h2 class=" as-filter-button-text">
                                            Pago pendiente
                                        </h2>
                                        ...
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2"><?php echo 'Payment method ID: ' . $_GET['payment_method_id'] ?></span>
                                                </p>

                                            </h3>
                                        </div>
                                        <h3>
                                            <?php echo 'External Reference: ' . $_GET['external_reference'] ?>
                                        </h3>
                                        <h3>
                                            <?php echo 'Payment ID: ' . $_GET['payment_id'] ?>
                                        </h3>
                                        <h3>
                                            <?php echo 'Collection ID: ' . $_GET['collection_id'] ?>
                                        </h3>
                                        <h3>
                                            <?php echo 'Payment Type: ' . $_GET['payment_type'] ?>
                                        </h3>
                                    </div>
                                </div>
                            </div>
